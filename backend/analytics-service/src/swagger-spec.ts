...
const swaggerSpecification: OpenAPIV3.Document = {
  openapi: '3.0.0',
  info: {
  ...
  components: {
    ...
    schemas: {
      AnalyticsReport: {
        type: 'object',
        required: ['reportType', 'period', 'startDate', 'endDate', 'data'],
        properties: {
          id: {
            type: 'string',
      ...
      PerformanceMetric: {
        type: 'object',
        required: ['vehicleId', 'metricType', 'timestamp', 'value'],
        properties: {
          id: {
            type: 'string',
            description: 'Auto-generated unique identifier',
